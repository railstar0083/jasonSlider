...
function autoSetHeight(i){
	...
	$(".jasonSlider").animate({height: currentHeight});
}
...
function autoSetWidth(i){
	...
	if($(".visibleSlide").children().is("iframe")) {
		  $(".jasonSlider").animate({width: currentWidth}, { queue: false, complete: function() {
			$("#modalLeft").animate({left: -32},{ queue: false });
			$("#modalRight").animate({right: -32},{ queue: false });
			setTimeout(function() {
		  ...
		  $(".jasonSlider").animate({width: currentWidth},{ queue: false });
		  $("#modalLeft").animate({left: 0},{ duration: 200, queue: false });
		  $("#modalRight").animate({right: 0},{ duration: 200, queue: false });
	  }
}
